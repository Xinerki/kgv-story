...
function MainScript() -- MAIN SCRIPT
	...
	Wait(5000)
	local carSpawn = vector3(4216.85, -1362.48, 21.85)
	local carRot = 174.5342
	...
	areaBlip = AddBlipForCoord(4788.17, -2860.97, 14.41)
	SetBlipColour(areaBlip, 5)
	SetBlipRoute(areaBlip, true)
	SetBlipRouteColour(areaBlip, 5)
	
	while GetDistanceBetweenCoords(4788.17, -2860.97, 14.41, GetEntityCoords(player)) > 100.0 do
		Wait(1)
		if IsPedDeadOrDying(player, 1) then
			str = "~r~Mission Failed"
			displayDoneMission = true
	...
	RemoveBlip(areaBlip)
	local target = CreatePed(4, 815693290, 4788.17, -2860.97, 14.41, 180.0, true, true)
